SCCore.lang.addLang({
    ru: {
        powered_by: '<a href="http://callbackhunter.com/free?utm_source=widget" class="cbh-powered-by-link" target="_blank">Поставьте CallbackHunter на свой сайт</a>',
        free_powered_by: '<a href="http://callbackhunter.com/free?utm_source=widget" class="cbh-powered-by-link" target="_blank">Поставьте CallbackHunter на свой сайт</a>',
        phoneIcon: {
        ...
        aboutBaloon: 'Через синюю кнопку связи CallbackHunter вы за 8 секунд дозвонитесь в любую компанию мира.<br><br>Хватит ждать на линии.<br>Освободите свое время.<br>Посвятите его близким.<br><br><a href="#{link}" target="_blank">Перейти на сайт</a>',
        ...
        intro: {
            ...
            head: "— Привет,",
            text: "закажем обратный звонок за #{countdown} ((секунда|секунды|секунд)):countdown или напишем письмо?",
        ...
        doYouWantCallback: {
            ...
            text_worktime: "мы перезвоним вам бесплатно за #{countdown} ((секунда|секунды|секунд)):countdown?",
        ...
        tellYourName: {
            head: "— Ok.",
            text: "Я #{callbackhunter} — новый стандарт связи клиента с компанией. А как вас зовут?",
            input_name: "Ваше имя и отчество",
            checkbox_oferta: 'Я принимаю <a target="_blank" href="http://callbackhunter.com/img/offerta_ru.pdf">соглашение</a>',
            action_saveName: "Будем знакомы!",
            link_pleasedToMeet: "Пропустить >>"
        },
        tellYourNameAgain: {
            head: "— #{plain_name}",
            text: "если вы не #{plain_name}, а представились шутливым именем, тогда укажите настоящее имя :)<br>Итак, я #{callbackhunter}, а вы?",
            input_name: "Ваше имя и отчество",
            checkbox_oferta: 'Я принимаю <a target="_blank" href="http://callbackhunter.com/img/offerta_ru.pdf">соглашение</a>',
            action_saveName: "Будем знакомы!"
        },
        ...
        doYouWantCallback2: {
            ...
            "text_work-name": "#{name}, я могу перезвонить вам за #{countdown} ((секунда|секунды|секунд)):countdown. Ведь по телефону обсуждать конкретику удобнее.",
            text_work: "Я могу перезвонить вам за #{countdown} ((секунда|секунды|секунд)):countdown. Ведь по телефону обсуждать конкретику удобнее.",
        ...
        contactForm: {
            "text-free-name": "чтобы вы получили ответ в<br/> течение 45 минут после начала <br/>рабочего дня. #{name}, пишите!",
            "text-free": "чтобы вы получили ответ в<br/> течение 45 минут после начала <br/>рабочего дня. Пишите!",
            "text-name": "чтобы вы получили ответ в<br/> течение 45 минут. #{name}, пишите!",
            text: "чтобы вы получили ответ в<br/> течение 45 минут. Пишите!",
            head: "— Сделаю всё,",
        ...
        callInNeed: {
            head: "— OK.",
            text: "Когда появятся вопросы, обязательно нажимайте <br/>синюю кнопку связи, хорошо?",
        ...
        gameFourthQuestion: {
            ...
            "text-business": 'вот <a href="http://goo.gl/tlrqYm" target="_blank">интересный канал</a> о бизнесе и счастье.',
            "head-music": "— Без музыки",
            "text-music": "жизнь была бы ошибкой. Фридрих Ницше.",
            "head-movies": "— Мне очень",
            "text-movies": "понравился «Интерстеллар». Рекомендую.",
            "head-other": "— Здорово,",
        ...
        exitWeTreasure: {
            ...
            text_worktime: "для вас есть персональное предложение! Давайте через <br/>#{countdown} ((секунда|секунды|секунд)):countdown обсудим цену для вас?",
        ...
        whatWouldYouLikeToBeCalled: {
            ...
            text: "Хотите, в следующий раз мы будем обращаться к вам по имени? Я #{callbackhunter}, а как вас зовут?",
        ...
        doYouWantRecordsOnEmail: {
            "head-free-name": "— #{name},",
            "text_worktime-free-name": "заявку отправил менеджеру. Также CallbackHunter может выслать вам на email запись будущего разговора.",
            "text_off-free-name": "заявку принял. #{callbackhunter} может выслать вам на email запись будущего разговора.",
            "head_worktime-free": "— Заявку отправил.",
            "text_worktime-free": "#{callbackhunter} может выслать вам на email запись будущего разговора.",
            "head_off-free": "— Заявку принял.",
            "text_off-free": "#{callbackhunter} может выслать вам на email запись будущего разговора.",
            "head-name": "— #{name},",
            "text_call_rated-name": "учтем оценку. Еще могу выслать вам на email запись этого разговора через #{callbackhunter}.",
            "text-name": "Еще могу выслать вам на email запись этого разговора через #{callbackhunter}.",
            head_call_rated: "— Учтем оценку!",
            text_call_rated: "Еще могу выслать вам на email запись этого разговора через #{callbackhunter}.",
            head: "— Еще могу",
            text: "выслать вам на email запись этого разговора через #{callbackhunter}.",
            input_email: "Ваш email",
        ...
        aboutMobile: {
            link_close: "Закрыть",
            main: 'Мы создали новый стандарт быстрой<br> связи клиента с компанией.<br><br>Через синюю кнопку связи вы ровно<br> за 8 секунд дозвонитесь в любую<br> компанию мира.<br><br>Освободите часть своего времени<br> и посвятите его близким.<br><br>Посетите наш сайт <a href="http://callbackhunter.com" target="_blank">callbackhunter.com</a>'
        }
    }
});
